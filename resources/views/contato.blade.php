...
<body>
    ...
    <div class="container">
        ...
        <form action="#" method="post">
            ...
            <button type="button" class="bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 text-white font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Enviar Mensagem</button>
            <!-- Adicione os botões de redes sociais aqui -->
            <div class="main">
  <div class="up">
    <button class="card1">
